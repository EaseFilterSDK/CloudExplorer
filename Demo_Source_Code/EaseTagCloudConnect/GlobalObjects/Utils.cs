    ...
    public class Utils
    {
        ...
        public static void CopyOSPlatformDependentFiles()
        {
            ...
            try
            {
                ...
                sourceFile = Path.Combine(sourceFolder, "EaseTag.sys");
                targetName = Path.Combine(localPath, "EaseTag.sys");
            ...
            {
                string lastError = "Copy platform dependent files 'FilterAPI.DLL' and 'EaseTag.sys' to folder " + localPath + " got exception:" + ex.Message;
