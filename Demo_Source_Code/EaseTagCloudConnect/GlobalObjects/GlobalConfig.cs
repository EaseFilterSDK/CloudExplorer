...
namespace EaseFilter.GlobalObjects
{
    ...
    public class GlobalConfig
    {
        ...
        static string eventSource = "EaseTag";
        ...
        static string cloudCacheFolder = "c:\\EaseTag\\CloudCacheFolder";
        public static string cloudStubFileFolder = "c:\\EaseTag\\CloudStubFileFolder";
        public static string testSourceFolder = @"c:\EaseTag\TestSourceFolder";
        public static string testStubFilesFolder = @"c:\EaseTag\TestStubFolder";
        ...
        public static bool SendConfigSettingsToFilter()
        {
            try
            {
                EaseTag.ResetConfigData();
                EaseTag.SetConnectionTimeout((uint)fileSystemWaitTimeoutInSeconds);
