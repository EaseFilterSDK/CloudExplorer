    ...
    public class SiteInfo
    {
        ...
        public string AzureSecretKey
        {
            get
            {
                ...
                {
                    decryptedKey = EaseTag.AESEncryptDecryptStr(decryptedKey, EaseTag.EncryptType.Decryption);
                }
            ...
            set
            {
                ...
                {
                    azureSecretKey = EaseTag.AESEncryptDecryptStr(azureSecretKey, EaseTag.EncryptType.Encryption);
                }
        ...
        public string S3SecretKey
        {
            ...
            set
            {
                ...
                {
                    s3SecretKey = EaseTag.AESEncryptDecryptStr(s3SecretKey, EaseTag.EncryptType.Encryption);
                }
        ...
        public string EncryptionPassPhrase
        {
            ...
            set
            {
                ...
                {
                    encryptionPassPhrase = EaseTag.AESEncryptDecryptStr(encryptionPassPhrase, EaseTag.EncryptType.Encryption);
                }
